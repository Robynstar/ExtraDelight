...
public class OvenRecipe implements Recipe<RecipeWrapper> {
    ...
    public OvenRecipe(ResourceLocation id, String group, @Nullable OvenRecipeBookTab tab, NonNullList<Ingredient> inputItems, ItemStack output, ItemStack container, float experience, int cookTime) {
        this.id = id;
        this.group = group;
        this.tab = tab;
    ...
    public boolean matches(RecipeWrapper inv, Level level) {
        ...
        return i == this.inputItems.size() && RecipeMatcher.findMatches(inputs, this.inputItems) != null && inv.getItem(INPUT_SLOTS + 1).getItem() == this.container.getItem();
    }
    ...
    public static class Serializer implements RecipeSerializer<OvenRecipe> {
        ...
        public OvenRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            if (inputItemsIn.isEmpty()) {
                ...
                return new OvenRecipe(recipeId, groupIn, tabIn, inputItemsIn, outputIn, container, experienceIn, cookTimeIn);
            }
        }

        @Nullable
        @Override
        public OvenRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buffer) {
            ...
            return new OvenRecipe(id, groupIn, tabIn, inputItemsIn, outputIn, container, experienceIn, cookTimeIn);
        }
