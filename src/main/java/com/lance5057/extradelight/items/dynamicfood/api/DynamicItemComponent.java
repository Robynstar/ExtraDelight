...
public class DynamicItemComponent {
	public static final DynamicItemComponent EMPTY = new DynamicItemComponent(NonNullList.create());
    public static final Codec<DynamicItemComponent> CODEC = DynamicItemComponent.Slot.CODEC
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, DynamicItemComponent> STREAM_CODEC = ItemStack.OPTIONAL_STREAM_CODEC
        ...
        .map(DynamicItemComponent::new, p_331691_ -> p_331691_.items);
    ...
    public boolean equals(Object other) {
        if (this == other) {
            ...
            if (other instanceof DynamicItemComponent DynamicItemComponent && ItemStack.listMatches(this.items, DynamicItemComponent.items)) {
                return true;
            }
    ...
    static record Slot(int index, ItemStack item) {
        public static final Codec<DynamicItemComponent.Slot> CODEC = RecordCodecBuilder.create(
            p_331695_ -> p_331695_.group(
                        Codec.intRange(0, 255).fieldOf("slot").forGetter(DynamicItemComponent.Slot::index),
