...
public class ExtraDelightItems {
	...
	public static final DeferredItem<Item> YEAST =EDItemGenerator.register("yeast",
			() -> new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> FLOUR = EDItemGenerator.register("flour",
			() -> new BlockItem(ExtraDelightBlocks.FLOUR.get(), new Item.Properties())).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> SLICED_TOMATO = EDItemGenerator.register("sliced_tomato",
			() -> new Item(foodItem(EDFoods.SLICED_TOMATO))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> SEAWEED_CRISPS = EDItemGenerator.register("seaweed_crisps",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.SEAWEED_CRISPS), true)).advancementMeal().finish();
	public static final DeferredItem<Item> SEAWEED_SALAD = EDItemGenerator.register("seaweed_salad",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.SEAWEED_SALAD), true)).advancementMeal().finish();

	public static final DeferredItem<Item> SUNFLOWER_SEEDS = EDItemGenerator.register("sunflower_seeds",
			() -> new Item(foodItem(EDFoods.EDIBLE_SEEDS))).advancementSnack().finish();
	...
	public static final DeferredItem<Item> GLOW_BERRY_JUICE = EDItemGenerator.register("glow_berry_juice",
			() -> new GlowberryJuiceItem(drinkItem())).advancementDrink().finish();
	public static final DeferredItem<Item> SWEET_BERRY_JUICE = EDItemGenerator.register("sweet_berry_juice",
			() -> new MelonJuiceItem(drinkItem())).advancementDrink().finish();
	...
	public static final DeferredItem<Item> CACTUS_JUICE = EDItemGenerator.register("cactus_juice",
			() -> new CactusJuiceItem(drinkItem())).advancementDrink().finish();

	// Custard
	public static final DeferredItem<Item> SWEET_BERRY_CUSTARD = EDItemGenerator.register("sweet_berry_custard",
			() -> new Item(stack16FoodItem(EDFoods.CUSTARD))).advancementDessert().finish();
	...
	public static final DeferredItem<Item> SWEET_BERRY_PIE_SLICE = EDItemGenerator.register("sweet_berry_pie_slice",
			() -> new Item(foodItem(FoodValues.PIE_SLICE))).advancementDessert().finish();
	public static final DeferredItem<Item> GLOW_BERRY_PIE_SLICE = EDItemGenerator.register("glow_berry_pie_slice",
			() -> new GlowberryFoodItem(foodItem(FoodValues.PIE_SLICE))).advancementDessert().finish();
	...
	public static final DeferredItem<Item> SWEET_BERRY_PIE_ITEM = EDItemGenerator.register("sweet_berry_pie",
			() -> new BlockItem(ExtraDelightBlocks.SWEET_BERRY_PIE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> GLOW_BERRY_PIE_ITEM = EDItemGenerator.register("glow_berry_pie",
			() -> new BlockItem(ExtraDelightBlocks.GLOW_BERRY_PIE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> CHEESECAKE_ITEM = EDItemGenerator.register("cheesecake",
			() -> new BlockItem(ExtraDelightBlocks.CHEESECAKE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> HONEY_CHEESECAKE_ITEM = EDItemGenerator.register("honey_cheesecake",
			() -> new BlockItem(ExtraDelightBlocks.HONEY_CHEESECAKE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> CHOCOLATE_CHEESECAKE_ITEM = EDItemGenerator.register("chocolate_cheesecake",
			() -> new BlockItem(ExtraDelightBlocks.CHOCOLATE_CHEESECAKE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> PUMPKIN_CHEESECAKE_ITEM = EDItemGenerator.register("pumpkin_cheesecake",
			() -> new BlockItem(ExtraDelightBlocks.PUMPKIN_CHEESECAKE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> GLOW_BERRY_CHEESECAKE_ITEM = EDItemGenerator.register("glow_berry_cheesecake",
			() -> new BlockItem(ExtraDelightBlocks.GLOW_BERRY_CHEESECAKE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> APPLE_CHEESECAKE_ITEM = EDItemGenerator.register("apple_cheesecake",
			() -> new BlockItem(ExtraDelightBlocks.APPLE_CHEESECAKE.get(), new Item.Properties())).advancementFeast().finish();

	// Cookies
	public static final DeferredItem<Item> PUMPKIN_COOKIE = EDItemGenerator.register("pumpkin_cookie",
			() -> new Item(foodItem(FoodValues.COOKIES))).advancementCookie().finish();
	...
	public static final DeferredItem<Item> GLOW_BERRY_COOKIE = EDItemGenerator.register("glow_berry_cookie",
			() -> new GlowberryFoodItem(foodItem(FoodValues.COOKIES))).advancementCookie().finish();
	...
	public static final DeferredItem<Item> GLOW_BERRY_POPSICLE = EDItemGenerator.register("glow_berry_popsicle",
			() -> new GlowberryPopsicleItem(foodItem(FoodValues.POPSICLE))).advancementDessert().finish();
	public static final DeferredItem<Item> SWEET_BERRY_POPSICLE = EDItemGenerator.register("sweet_berry_popsicle",
			() -> new Item(foodItem(FoodValues.POPSICLE))).advancementDessert().finish();
	...
	public static final DeferredItem<Item> WHIPPED_CREAM = EDItemGenerator.register("whipped_cream",
			() -> new Item(new MilkBottleItem.Properties().food(EDFoods.WHIPPED_CREAM).craftRemainder(Items.BOWL))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> SCRAMBLED_EGGS = EDItemGenerator.register("scrambled_eggs",
			() -> new Item(foodItem(EDFoods.SCRAMBLED_EGGS).craftRemainder(Items.BOWL))).advancementMeal().finish();
	...
	public static final DeferredItem<Item> OMELETTE = EDItemGenerator.register("omelette",
			() -> new Item(new Item.Properties().food(EDFoods.OMELETTE))).advancementMeal().finish();

	public static final DeferredItem<Item> BOILED_EGG = EDItemGenerator.register("boiled_egg",
			() -> new Item(foodItem(FoodValues.FRIED_EGG))).advancementSnack().finish();

	public static final DeferredItem<Item> QUICHE = EDItemGenerator.register("quiche",
			() -> new BlockItem(ExtraDelightBlocks.QUICHE.get(), new Item.Properties())).advancementFeast().finish();

	public static final DeferredItem<Item> QUICHE_SLICE = EDItemGenerator.register("quiche_slice",
			() -> new Item(foodItem(EDFoods.QUICHE))).advancementMeal().finish();

	public static final DeferredItem<Item> EGG_BASKET = EDItemGenerator.register("egg_in_the_basket",
			() -> new Item(foodItem(EDFoods.EGG_BASKET))).advancementMeal().finish();

	public static final DeferredItem<Item> EGG_SALAD = EDItemGenerator.register("egg_salad",
			() -> new Item(foodItem(EDFoods.EGG_SALAD).craftRemainder(Items.BOWL))).advancementMeal().finish();

	// Condiments
	public static final DeferredItem<Item> BBQ_SAUCE = EDItemGenerator.register("bbq_jar_item",
			() -> new DrinkableItem(foodItem(EDFoods.BBQ).craftRemainder(Items.GLASS_BOTTLE))).advancementIngredients().finish();
	public static final DeferredItem<Item> KETCHUP = EDItemGenerator.register("ketchup_jar_item",
			() -> new DrinkableItem(foodItem(EDFoods.KETCHUP).craftRemainder(Items.GLASS_BOTTLE))).advancementIngredients().finish();
	public static final DeferredItem<Item> MAYO = EDItemGenerator.register("mayo_jar_item",
			() -> new DrinkableItem(foodItem(EDFoods.MAYO).craftRemainder(Items.GLASS_BOTTLE))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> JAM = EDItemGenerator.register("jam",
			() -> new Item(foodItem(EDFoods.JAM).craftRemainder(Items.GLASS_BOTTLE))).advancementIngredients().finish();
	public static final DeferredItem<Item> GLOW_BERRY_JAM = EDItemGenerator.register("glow_berry_jam",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.GLOW_JAM).craftRemainder(Items.GLASS_BOTTLE), true)).advancementIngredients().finish();
	public static final DeferredItem<Item> GOLDEN_APPLE_JAM = EDItemGenerator.register("golden_apple_jam",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.GOLDEN_JAM).craftRemainder(Items.GLASS_BOTTLE), true)).advancementIngredients().finish();

	// Bread

	public static final DeferredItem<Item> JAM_TOAST = EDItemGenerator.register("jam_toast",
			() -> new Item(foodItem(EDFoods.JAM_BREAD))).advancementMeal().finish();
	public static final DeferredItem<Item> GLOW_JAM_TOAST = EDItemGenerator.register("glow_jam_toast",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.GLOW_JAM_BREAD), true)).advancementMeal().finish();
	public static final DeferredItem<Item> GOLDEN_JAM_TOAST = EDItemGenerator.register("golden_jam_toast",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.GOLDEN_JAM_BREAD), true)).advancementMeal().finish();

	// Potato
	public static final DeferredItem<Item> GRATED_POTATO = EDItemGenerator.register("grated_potato",
			() -> new Item(foodItem(Foods.POTATO))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> POTATO_CHIPS = EDItemGenerator.register("potato_chips",
			() -> new Item(foodItem(EDFoods.FRIED_POTATO))).advancementSnack().finish();
	public static final DeferredItem<Item> HASHBROWNS = EDItemGenerator.register("hashbrowns",
			() -> new Item(foodItem(EDFoods.FRIED_POTATO))).advancementMeal().finish();
	...
	public static final DeferredItem<Item> PORK_STEW = EDItemGenerator.register("pork_stew",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.PORK_STEW), true)).advancementMeal().finish();
	public static final DeferredItem<Item> LAMB_STEW = EDItemGenerator.register("lamb_stew",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.LAMB_STEW), true)).advancementMeal().finish();
	public static final DeferredItem<Item> CHICKEN_STEW = EDItemGenerator.register("chicken_stew",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.CHICKEN_STEW), true)).advancementMeal().finish();
	public static final DeferredItem<Item> CURRY = EDItemGenerator.register("curry",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.CURRY), true)).advancementMeal().finish();

	public static final DeferredItem<Item> BEEF_STEW_RICE = EDItemGenerator.register("beef_stew_rice",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.BEEF_STEW_RICE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> PORK_STEW_RICE = EDItemGenerator.register("pork_stew_rice",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.PORK_STEW_RICE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> LAMB_STEW_RICE = EDItemGenerator.register("lamb_stew_rice",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.LAMB_STEW_RICE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> RABBIT_STEW_RICE = EDItemGenerator.register("rabbit_stew_rice",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.RABBIT_STEW_RICE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> CHICKEN_STEW_RICE = EDItemGenerator.register("chicken_stew_rice",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.CHICKEN_STEW_RICE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> FISH_STEW_RICE = EDItemGenerator.register("fish_stew_rice",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.FISH_STEW_RICE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> CURRY_RICE = EDItemGenerator.register("curry_rice",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.CURRY_RICE), true)).advancementMeal().finish();

	public static final DeferredItem<Item> BEEF_STEW_FEAST = EDItemGenerator.register("beef_stew_feast",
			() -> new BlockItem(ExtraDelightBlocks.BEEF_STEW.get(), new Item.Properties().stacksTo(1))).advancementFeast().finish();
	public static final DeferredItem<Item> PORK_STEW_FEAST = EDItemGenerator.register("pork_stew_feast",
			() -> new BlockItem(ExtraDelightBlocks.PORK_STEW.get(), new Item.Properties().stacksTo(1))).advancementFeast().finish();
	public static final DeferredItem<Item> LAMB_STEW_FEAST = EDItemGenerator.register("lamb_stew_feast",
			() -> new BlockItem(ExtraDelightBlocks.LAMB_STEW.get(), new Item.Properties().stacksTo(1))).advancementFeast().finish();
	public static final DeferredItem<Item> RABBIT_STEW_FEAST = EDItemGenerator.register("rabbit_stew_feast",
			() -> new BlockItem(ExtraDelightBlocks.RABBIT_STEW.get(), new Item.Properties().stacksTo(1))).advancementFeast().finish();
	public static final DeferredItem<Item> CHICKEN_STEW_FEAST = EDItemGenerator.register("chicken_stew_feast",
			() -> new BlockItem(ExtraDelightBlocks.CHICKEN_STEW.get(), new Item.Properties().stacksTo(1))).advancementFeast().finish();
	public static final DeferredItem<Item> FISH_STEW_FEAST = EDItemGenerator.register("fish_stew_feast",
			() -> new BlockItem(ExtraDelightBlocks.FISH_STEW.get(), new Item.Properties().stacksTo(1))).advancementFeast().finish();
	public static final DeferredItem<Item> CURRY_FEAST = EDItemGenerator.register("curry_feast",
			() -> new BlockItem(ExtraDelightBlocks.CURRY.get(), new Item.Properties().stacksTo(1))).advancementFeast().finish();

	public static final DeferredItem<Item> SAUSAGE_ROLL = EDItemGenerator.register("sausage_roll",
			() -> new Item(stack16FoodItem(EDFoods.SAUSAGE_ROLL))).advancementButchercraft().finish();
	public static final DeferredItem<Item> SOS = EDItemGenerator.register("sos",
			() -> new Item(stack16FoodItem(EDFoods.SOS))).advancementButchercraft().finish();
	public static final DeferredItem<Item> LIVER_ONIONS = EDItemGenerator.register("liver_onions",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.LIVERONION), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> FRIED_FISH = EDItemGenerator.register("fried_fish",
			() -> new Item(stack16FoodItem(EDFoods.FRIED_FISH))).advancementMeal().finish();
	public static final DeferredItem<Item> CHICKEN_FRIED_STEAK = EDItemGenerator.register("chicken_fried_steak",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.CHICKEN_FRIED_STEAK), true)).advancementMeal().finish();
	public static final DeferredItem<Item> PORK_TENDERLOIN = EDItemGenerator.register("pork_tenderloin",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.PORK_TENDERLOIN), true)).advancementMeal().finish();
	public static final DeferredItem<Item> PORK_TENDERLOIN_SANDWICH = EDItemGenerator.register("pork_tenderloin_sandwich",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.PORK_TENDERLOIN_SANDWICH), true)).advancementMeal().finish();
	public static final DeferredItem<Item> FRIED_CHICKEN = EDItemGenerator.register("fried_chicken",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.FRIED_CHICKEN), true)).advancementMeal().finish();
	public static final DeferredItem<Item> STUFFED_HEART = EDItemGenerator.register("stuffed_heart",
			() -> new Item(stack16FoodItem(EDFoods.STUFFED_HEART))).advancementButchercraft().finish();
	public static final DeferredItem<Item> FRIED_BRAINS = EDItemGenerator.register("fried_brains",
			() -> new Item(stack16FoodItem(EDFoods.FRIED_BRAIN))).advancementButchercraft().finish();
	public static final DeferredItem<Item> OXTAIL_SOUP = EDItemGenerator.register("oxtail_soup",
			() -> new ToolTipConsumableItem(bowlFoodItem(EDFoods.OXTAIL_SOUP), true)).advancementButchercraft().finish();

	public static final DeferredItem<Item> CHEESE_SANDWICH = EDItemGenerator.register("cheese_sandwich",
			() -> new Item(stack16FoodItem(EDFoods.CHEESE_SANDWICH))).advancementMeal().finish();
	public static final DeferredItem<Item> GRILLED_CHEESE = EDItemGenerator.register("grilled_cheese",
			() -> new Item(stack16FoodItem(EDFoods.GRILLED_CHEESE))).advancementMeal().finish();

	public static final DeferredItem<Item> HASH = EDItemGenerator.register("hash",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.HASH), true)).advancementMeal().finish();
	public static final DeferredItem<Item> POT_ROAST = EDItemGenerator.register("potroast",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.POT_ROAST), true)).advancementButchercraft().finish();

	public static final DeferredItem<Item> MEAT_LOAF_FEAST = EDItemGenerator.register("meatloaf_feast",
			() -> new BlockItem(ExtraDelightBlocks.MEATLOAF_FEAST.get(), new Item.Properties().stacksTo(1))).advancementFeast().finish();
	public static final DeferredItem<Item> MEAT_LOAF = EDItemGenerator.register("meatloaf",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.MEAT_LOAF), true)).advancementMeal().finish();
	public static final DeferredItem<Item> MEAT_LOAF_SANDWICH = EDItemGenerator.register("meatloaf_sandwich",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.MEAT_LOAF_SANDWICH), true)).advancementMeal().finish();

	public static final DeferredItem<Item> BBQ_RIBS = EDItemGenerator.register("bbq_ribs",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.BBQ_RIBS), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> MEAT_PIE_SLICE = EDItemGenerator.register("meat_pie_slice",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.MEAT_PIE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> PULLED_PORK_SANDWICH = EDItemGenerator.register("pulled_pork_sandwich",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.PULLED_PORK_SANDWICH), true)).advancementButchercraft().finish();

	public static final DeferredItem<Item> RACK_LAMB = EDItemGenerator.register("rack_lamb",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.RACK_LAMB), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> STIRFRY = EDItemGenerator.register("stirfry",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.STIRFRY_RICE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> BEEF_WELLINGTON = EDItemGenerator.register("beef_wellington",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.WELLINGTON), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> HAGGIS = EDItemGenerator.register("haggis",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.HAGGIS), true)).advancementButchercraft().finish();

	public static final DeferredItem<Item> JELLY_WHITE = EDItemGenerator.register("jelly_white",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.JELLY).craftRemainder(Items.BOWL), true)).advancementDessert().finish();
	...
	public static final DeferredItem<Item> HASH_FEAST_ITEM = EDItemGenerator.register("hash_block_item",
			() -> new BlockItem(ExtraDelightBlocks.HASH_FEAST.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> POT_ROAST_FEAST_ITEM = EDItemGenerator.register("pot_roast_block_item",
			() -> new BlockItem(ExtraDelightBlocks.POT_ROAST_FEAST.get(), new Item.Properties())).advancementButchercraft().finish();

	public static final DeferredItem<Item> BBQ_RIBS_FEAST_ITEM = EDItemGenerator.register("bbq_ribs_block_item",
			() -> new BlockItem(ExtraDelightBlocks.BBQ_RIBS_FEAST.get(), new Item.Properties())).advancementButchercraft().finish();
	public static final DeferredItem<Item> MEAT_PIE_BLOCK_ITEM = EDItemGenerator.register("meat_pie_block_item",
			() -> new BlockItem(ExtraDelightBlocks.MEAT_PIE_BLOCK.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> PULLED_PORK_FEAST_ITEM = EDItemGenerator.register("pulled_pork_block_item",
			() -> new BlockItem(ExtraDelightBlocks.PULLED_PORK_FEAST.get(), new Item.Properties())).advancementButchercraft().finish();

	public static final DeferredItem<Item> RACK_LAMB_FEAST_ITEM = EDItemGenerator.register("rack_lamb_block_item",
			() -> new BlockItem(ExtraDelightBlocks.RACK_LAMB.get(), new Item.Properties())).advancementButchercraft().finish();
	public static final DeferredItem<Item> STIRFRY_FEAST_ITEM = EDItemGenerator.register("stirfry_block_item",
			() -> new BlockItem(ExtraDelightBlocks.STIRFRY.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> BEEF_WELLINGTON_FEAST_ITEM = EDItemGenerator.register("beef_wellington_block_item",
			() -> new BlockItem(ExtraDelightBlocks.BEEF_WELLINGTON.get(), new Item.Properties())).advancementButchercraft().finish();
	public static final DeferredItem<Item> HAGGIS_FEAST_ITEM = EDItemGenerator.register("haggis_block_item",
			() -> new BlockItem(ExtraDelightBlocks.HAGGIS.get(), new Item.Properties())).advancementButchercraft().finish();
	...
	public static final DeferredItem<Item> JERKY = EDItemGenerator.register("jerky",
			() -> new Item(foodItem(EDFoods.JERKY))).advancementSnack().finish();

	public static final DeferredItem<Item> BREAD_SLICE = EDItemGenerator.register("bread_slice",
			() -> new Item(foodItem(EDFoods.SLICED_BREAD))).advancementIngredients().finish();
	public static final DeferredItem<Item> TOAST = EDItemGenerator.register("toast",
			() -> new Item(foodItem(EDFoods.SLICED_BREAD))).advancementSnack().finish();
	public static final DeferredItem<Item> BREAD_CRUMBS = EDItemGenerator.register("breadcrumbs",
			() -> new BlockItem(ExtraDelightBlocks.BREADCRUMBS.get(), foodItem(EDFoods.SLICED_BREAD))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> MACARONI_CHEESE = EDItemGenerator.register("macaroni_cheese",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.MACARONI_AND_CHEESE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> MACARONI_CHEESE_FEAST = EDItemGenerator.register("macaroni_cheese_feast",
			() -> new BlockItem(ExtraDelightBlocks.MACARONI_CHEESE.get(), new Item.Properties())).advancementFeast().finish();

	public static final DeferredItem<Item> LASAGNA = EDItemGenerator.register("lasanga",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.LASAGNA), true)).advancementMeal().finish();
	public static final DeferredItem<Item> LASAGNA_FEAST = EDItemGenerator.register("lasanga_feast",
			() -> new BlockItem(ExtraDelightBlocks.LASAGNA.get(), new Item.Properties())).advancementFeast().finish();

	public static final DeferredItem<Item> HOTDISH = EDItemGenerator.register("hotdish",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.HOTDISH), true)).advancementMeal().finish();
	public static final DeferredItem<Item> HOTDISH_FEAST = EDItemGenerator.register("hotdish_feast",
			() -> new BlockItem(ExtraDelightBlocks.HOTDISH.get(), new Item.Properties())).advancementFeast().finish();

	// Rice
	public static final DeferredItem<Item> FURIKAKE_RICE = EDItemGenerator.register("furikake_rice",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.FURIKAKE_RICE), true)).advancementMeal().finish();
	...
	public static final DeferredItem<Item> FISH_CAKES = EDItemGenerator.register("fish_cakes",
			() -> new Item(foodItem(EDFoods.FISH_CAKES))).advancementMeal().finish();
	public static final DeferredItem<Item> FISH_AND_CHIPS = EDItemGenerator.register("fish_chips",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.FISH_CHIPS), true)).advancementMeal().finish();

	// Mushrooms
	public static final DeferredItem<Item> FRIED_MUSHROOMS = EDItemGenerator.register("fried_mushrooms",
			() -> new Item(foodItem(EDFoods.FRIED_MUSHROOMS))).advancementMeal().finish();
	public static final DeferredItem<Item> MUSHROOM_RISOTTO = EDItemGenerator.register("mushroom_risotto",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.MUSHROOM_RISOTTO), true)).advancementMeal().finish();
	public static final DeferredItem<Item> STUFFED_MUSHROOMS = EDItemGenerator.register("stuffed_mushrooms",
			() -> new Item(foodItem(EDFoods.STUFFED_MUSHROOMS))).advancementMeal().finish();
	public static final DeferredItem<Item> MUSHROOM_BURGER = EDItemGenerator.register("mushroom_burger",
			() -> new Item(foodItem(EDFoods.MUSHROOM_BURGER))).advancementMeal().finish();

	public static final DeferredItem<Item> BACON_EGG_SANDWICH = EDItemGenerator.register("bacon_egg_sandwich",
			() -> new Item(foodItem(EDFoods.BACON_EGG_SANDWICH))).advancementMeal().finish();
	public static final DeferredItem<Item> BACON_EGG_CHEESE_SANDWICH = EDItemGenerator.register("bacon_egg_cheese_sandwich",
			() -> new Item(foodItem(EDFoods.BACON_EGG_CHEESE_SANDWICH))).advancementMeal().finish();

	public static final DeferredItem<Item> BUTTERED_TOAST = EDItemGenerator.register("buttered_toast",
			() -> new Item(foodItem(EDFoods.BUTTERED_TOAST))).advancementMeal().finish();
	...
	public static final DeferredItem<Item> CACTUS = EDItemGenerator.register("cactus",
			() -> new Item(foodItem(EDFoods.CACTUS))).advancementIngredients().finish();
	public static final DeferredItem<Item> COOKED_CACTUS = EDItemGenerator.register("cooked_cactus",
			() -> new Item(foodItem(EDFoods.COOKED_CACTUS))).advancementMeal().finish();
	public static final DeferredItem<Item> CACTUS_EGGS = EDItemGenerator.register("cactus_eggs",
			() -> new Item(foodItem(EDFoods.CACTUS_EGGS))).advancementMeal().finish();
	public static final DeferredItem<Item> CACTUS_SOUP = EDItemGenerator.register("cactus_soup",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CACTUS_SOUP), true)).advancementMeal().finish();
	public static final DeferredItem<Item> CACTUS_SALAD = EDItemGenerator.register("cactus_salad",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CACTUS_SALAD), true)).advancementMeal().finish();
	public static final DeferredItem<Item> STUFFED_CACTUS = EDItemGenerator.register("stuffed_cactus",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.STUFFED_CACTUS), true)).advancementMeal().finish();

	public static final DeferredItem<Item> CORN_SEEDS = EDItemGenerator.register("corn_seeds",
			() -> new ItemNameBlockItem(ExtraDelightBlocks.CORN_BOTTOM.get(), new Item.Properties())).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> TEA = EDItemGenerator.register("tea",
			() -> new CornSilkTeaItem(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE))).advancementDrink().finish();
	public static final DeferredItem<Item> STEWED_APPLES = EDItemGenerator.register("stewed_apples",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.STEWED_APPLES).craftRemainder(Items.BOWL), true)).advancementMeal().finish();
	public static final DeferredItem<Item> APPLE_FRITTERS = EDItemGenerator.register("apple_fritters",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.APPLE_FRITTERS), true)).advancementMeal().finish();
	public static final DeferredItem<Item> CARAMEL_SAUCE = EDItemGenerator.register("caramel_sauce",
			() -> new Item(foodItem(EDFoods.CARAMEL_SAUCE).craftRemainder(Items.GLASS_BOTTLE))).advancementIngredients().finish();
	public static final DeferredItem<Item> CARAMEL_CANDY = EDItemGenerator.register("caramel_candy",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CARAMEL_CANDY), true)).advancementCandy().finish();
	public static final DeferredItem<Item> CANDY_APPLE = EDItemGenerator.register("candy_apple",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CANDY_APPLE), true)).advancementDessert().finish();
	public static final DeferredItem<Item> CARAMEL_APPLE = EDItemGenerator.register("caramel_apple",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CARAMEL_APPLE), true)).advancementDessert().finish();
	public static final DeferredItem<Item> CANDY_GOLDEN_APPLE = EDItemGenerator.register("candy_golden_apple",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CANDY_GOLDEN_APPLE), true)).advancementDessert().finish();
	public static final DeferredItem<Item> CARAMEL_GOLDEN_APPLE = EDItemGenerator.register("caramel_golden_apple",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CARAMEL_GOLDEN_APPLE), true)).advancementDessert().finish();
	public static final DeferredItem<Item> CARAMEL_POPCORN = EDItemGenerator.register("caramel_popcorn",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CARAMEL_POPCORN), true)).advancementSnack().finish();
	public static final DeferredItem<Item> CARAMEL_CUSTARD = EDItemGenerator.register("caramel_custard",
			() -> new Item(foodItem(EDFoods.CUSTARD))).advancementDessert().finish();
	...
	public static final DeferredItem<Item> CARAMEL_CHEESECAKE_ITEM = EDItemGenerator.register("caramel_cheesecake_item",
			() -> new BlockItem(ExtraDelightBlocks.CARAMEL_CHEESECAKE.get(), new Item.Properties())).advancementFeast().finish();

	public static final DeferredItem<Item> CORNBREAD = EDItemGenerator.register("cornbread",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CORNBREAD), true)).advancementMeal().finish();
	public static final DeferredItem<Item> CORNBREAD_FEAST = EDItemGenerator.register("cornbread_feast",
			() -> new BlockItem(ExtraDelightBlocks.CORNBREAD.get(), new Item.Properties())).advancementFeast().finish();

	public static final DeferredItem<Item> CORN_PUDDING = EDItemGenerator.register("corn_pudding",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CORN_PUDDING), true)).advancementMeal().finish();
	public static final DeferredItem<Item> CORN_PUDDING_FEAST = EDItemGenerator.register("corn_pudding_feast",
			() -> new BlockItem(ExtraDelightBlocks.CORN_PUDDING.get(), new Item.Properties())).advancementFeast().finish();
	...
	public static final DeferredItem<Item> PUMPKIN_PIE_ITEM = EDItemGenerator.register("pumpkin_pie_item",
			() -> new BlockItem(ExtraDelightBlocks.PUMPKIN_PIE.get(), new Item.Properties())).advancementFeast().finish();
	...
	public static final DeferredItem<Item> PUMPKIN_ROLL_FEAST = EDItemGenerator.register("pumpkin_roll_feast",
			() -> new BlockItem(ExtraDelightBlocks.PUMPKIN_ROLL.get(), new Item.Properties())).advancementFeast().finish();

	public static final DeferredItem<Item> APPLE_CRISP = EDItemGenerator.register("apple_crisp",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.APPLE_CRISP), true)).advancementDessert().finish();
	public static final DeferredItem<Item> APPLE_CRISP_FEAST = EDItemGenerator.register("apple_crisp_feast",
			() -> new BlockItem(ExtraDelightBlocks.APPLE_CRISP.get(), new Item.Properties())).advancementFeast().finish();

	public static final DeferredItem<Item> STUFFING = EDItemGenerator.register("stuffing",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.STUFFING), true)).advancementMeal().finish();
	public static final DeferredItem<Item> STUFFING_FEAST = EDItemGenerator.register("stuffing_feast",
			() -> new BlockItem(ExtraDelightBlocks.STUFFING.get(), new Item.Properties())).advancementFeast().finish();

	public static final DeferredItem<Item> POTATO_AU_GRATIN = EDItemGenerator.register("potato_au_gratin",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.POTATOES_AU_GRATIN), true)).advancementMeal().finish();
	public static final DeferredItem<Item> POTATO_AU_GRATIN_FEAST = EDItemGenerator.register("potato_au_gratin_feast",
			() -> new BlockItem(ExtraDelightBlocks.POTATO_AU_GRATIN.get(), new Item.Properties())).advancementFeast().finish();
	...
	public static final DeferredItem<Item> ICE_CREAM = EDItemGenerator.register("ice_cream",
			() -> new Item(foodItem(EDFoods.ICE_CREAM).craftRemainder(Items.BOWL))).advancementDessert().finish();
	public static final DeferredItem<Item> CHOCOLATE_ICE_CREAM = EDItemGenerator.register("chocolate_ice_cream",
			() -> new Item(foodItem(EDFoods.TOPPED_ICE_CREAM).craftRemainder(Items.BOWL))).advancementDessert().finish();
	public static final DeferredItem<Item> GLOW_BERRY_ICE_CREAM = EDItemGenerator.register("glow_berry_ice_cream",
			() -> new GlowberryFoodItem(foodItem(EDFoods.TOPPED_ICE_CREAM).craftRemainder(Items.BOWL))).advancementDessert().finish();
	...
	public static final DeferredItem<Item> MILKSHAKE = EDItemGenerator.register("milkshake",
			() -> new MilkshakeDrinkItem(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE), 2f)).advancementDrink().finish();
	public static final DeferredItem<Item> CHOCOLATE_MILKSHAKE = EDItemGenerator.register("chocolate_milkshake",
			() -> new MilkshakeDrinkItem(new Item.Properties(), 4f)).advancementDrink().finish();
	...
	public static final DeferredItem<Item> CHOCOLATE_MILK = EDItemGenerator.register("chocolate_milk",
			() -> new HotCocoaItem(new Item.Properties())).advancementDrink().finish();
	...
	public static final DeferredItem<Item> GINGER_BEER = EDItemGenerator.register("ginger_beer",
			() -> new MelonJuiceItem(new Item.Properties())).advancementDrink().finish();
	...
	public static final DeferredItem<Item> GINGERBREAD_COOKIE_DOUGH = EDItemGenerator.register("gingerbread_cookie_dough",
			() -> new Item(foodItem(EDFoods.COOKIE_DOUGH))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> MINT = EDItemGenerator.register("mint",
			() -> new ItemNameBlockItem(ExtraDelightBlocks.MINT_CROP.get(), new Item.Properties())).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> FROSTING_WHITE = EDItemGenerator.register("frosting_white",
			() -> new FrostingItem(foodItem(EDFoods.FROSTING))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> CANDY_WHITE = EDItemGenerator.register("candy_white",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CANDY), true)).advancementCandy().finish();
	...
	public static final DeferredItem<Item> MINT_CANDY_RED = EDItemGenerator.register("mint_candy_red",
			() -> new Item(foodItem(EDFoods.SUGAR))).advancementCandy().finish();
	...
	public static final DeferredItem<Item> FRENCH_TOAST = EDItemGenerator.register("french_toast",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.FRENCH_TOAST), true)).advancementDessert().finish();
	public static final DeferredItem<Item> CONGEE = EDItemGenerator.register("congee",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CONGEE), true)).advancementMeal().finish();
	public static final DeferredItem<Item> LUGAW = EDItemGenerator.register("lugaw",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.LUGAW), true)).advancementMeal().finish();
	public static final DeferredItem<Item> RICE_PUDDING = EDItemGenerator.register("rice_pudding",
			() -> new Item(foodItem(FoodValues.GLOW_BERRY_CUSTARD))).advancementDessert().finish();

	public static final DeferredItem<Item> MUFFIN_GINGER = EDItemGenerator.register("muffin_ginger",
			() -> new Item(foodItem(EDFoods.MUFFIN))).advancementDessert().finish();
	...
	public static final DeferredItem<Item> FRUIT_BREAD = EDItemGenerator.register("fruit_bread",
			() -> new Item(foodItem(EDFoods.FILLED_BREAD))).advancementDessert().finish();
	public static final DeferredItem<Item> PICKLED_GINGER = EDItemGenerator.register("pickled_ginger",
			() -> new Item(foodItem(EDFoods.PICKLED_GINGER))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> PUNCH_FEAST = EDItemGenerator.register("punch_feast",
			() -> new BlockItem(ExtraDelightBlocks.PUNCH.get(), new Item.Properties())).advancementFeast().finish();

	public static final DeferredItem<Item> MILK_TART_SLICE = EDItemGenerator.register("milk_tart_slice",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.MILK_TART), true)).advancementDessert().finish();
	public static final DeferredItem<Item> MILK_TART_FEAST = EDItemGenerator.register("milk_tart_feast",
			() -> new BlockItem(ExtraDelightBlocks.MILK_TART.get(), new Item.Properties())).advancementFeast().finish();
	...
	public static final DeferredItem<Item> CHILI = EDItemGenerator.register("chili",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CHILI), true)).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> ROASTED_COCOA_BEANS = EDItemGenerator.register("roasted_cocoa_beans",
			() -> new Item(foodItem(EDFoods.NUTS))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> WHITE_CHOCOLATE_BAR = EDItemGenerator.register("white_chocolate_bar",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CHOCOLATE_BAR), true)).advancementCandy().finish();
	...
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_BAR = EDItemGenerator.register("blood_chocolate_bar",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CHOCOLATE_BAR), true)).advancementButchercraft().finish();

	public static final DeferredItem<Item> WHITE_CHOCOLATE_CHIPS = EDItemGenerator.register("white_chocolate_chips",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CHOCOLATE_CHIPS), true)).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_CHIPS = EDItemGenerator.register("blood_chocolate_chips",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CHOCOLATE_CHIPS), true)).advancementButchercraft().finish();

	public static final DeferredItem<Item> WHITE_CHOCOLATE_FILLED_BAR = EDItemGenerator.register("white_chocolate_filled_bar",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.FILLED_CHOCOLATE_BAR), true)).advancementCandy().finish();
	...
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_FILLED_BAR = EDItemGenerator.register("blood_chocolate_filled_bar",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.FILLED_CHOCOLATE_BAR), true)).advancementButchercraft().finish();

	public static final DeferredItem<Item> WHITE_CHOCOLATE_TRUFFLE = EDItemGenerator.register("white_chocolate_truffle",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CHOCOLATE_TRUFFLE), true)).advancementCandy().finish();
	...
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_TRUFFLE = EDItemGenerator.register("blood_chocolate_truffle",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CHOCOLATE_TRUFFLE), true)).advancementButchercraft().finish();

	public static final DeferredItem<Item> MARSHMALLOW = EDItemGenerator.register("marshmallow",
			() -> new Item(foodItem(EDFoods.MARSHMALLOW))).advancementCandy().finish();
	...
	public static final DeferredItem<Item> PEANUT_BUTTER_CUP = EDItemGenerator.register("peanut_butter_cup",
			() -> new Item(foodItem(EDFoods.CHOCOLATE_TRUFFLE))).advancementCandy().finish();
	...
	public static final DeferredItem<Item> XOCOLATL = EDItemGenerator.register("xocolati",
			() -> new XocolatlItem(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE))).advancementDrink().finish();
	public static final DeferredItem<Item> GOURMET_HOT_CHOCOLATE = EDItemGenerator.register("gourmet_hot_chocolate",
			() -> new GourmetHotCocoa(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE))).advancementDrink().finish();
	...
	public static final DeferredItem<Item> COFFEE_JELLY = EDItemGenerator.register("coffee_jelly",
			() -> new Item(foodItem(EDFoods.JELLY).craftRemainder(Items.GLASS_BOTTLE))).advancementDessert().finish();
	public static final DeferredItem<Item> TOFFEE = EDItemGenerator.register("toffee",
			() -> new Item(foodItem(EDFoods.TOFFEE))).advancementCandy().finish();
	public static final DeferredItem<Item> GRAHAM_CRACKER = EDItemGenerator.register("graham_cracker",
			() -> new Item(foodItem(EDFoods.GRAHAM_CRACKER))).advancementSnack().finish();
	public static final DeferredItem<Item> SMORE = EDItemGenerator.register("smore",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.SMORE), true)).advancementDessert().finish();
	public static final DeferredItem<Item> PEPPERMINT_BARK = EDItemGenerator.register("peppermint_bark",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.PEPPERMINT_BARK), true)).advancementCandy().finish();
	public static final DeferredItem<Item> DIRT_CAKE = EDItemGenerator.register("dirt_cake",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIRT_CAKE), true)).advancementDessert().finish();
	...
	public static final DeferredItem<Item> COFFEE = EDItemGenerator.register("coffee",
			() -> new CoffeeItem(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE))).advancementDrink().finish();

	public static final DeferredItem<Item> BROWNIES_BLOCK = EDItemGenerator.register("brownies_block",
			() -> new BlockItem(ExtraDelightBlocks.BROWNIES.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> BROWNIE = EDItemGenerator.register("brownie",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.BROWNIE), true)).advancementDessert().finish();

	public static final DeferredItem<Item> BLONDIES_BLOCK = EDItemGenerator.register("blondies_block",
			() -> new BlockItem(ExtraDelightBlocks.BLONDIES.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> BLONDIE = EDItemGenerator.register("blondie",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.BLONDIE), true)).advancementDessert().finish();

	public static final DeferredItem<Item> CHOCOLATE_CAKE_BLOCK = EDItemGenerator.register("chocolate_cake_block",
			() -> new BlockItem(ExtraDelightBlocks.CHOCOLATE_CAKE.get(), new Item.Properties())).advancementFeast().finish();
	...
	public static final DeferredItem<Item> FUDGE_BLOCK = EDItemGenerator.register("fudge_block",
			() -> new BlockItem(ExtraDelightBlocks.FUDGE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> FUDGE_SLICE = EDItemGenerator.register("fudge",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.FUDGE), true)).advancementCandy().finish();

	public static final DeferredItem<Item> STICKY_TOFFEE_PUDDING_BLOCK = EDItemGenerator.register("sticky_toffee_pudding_block",
			() -> new BlockItem(ExtraDelightBlocks.STICKY_TOFFEE_PUDDING.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> STICKY_TOFFEE_PUDDING_SLICE = EDItemGenerator.register("sticky_toffee_pudding_slice",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.STICKY_TOFFEE_PUDDING).craftRemainder(Items.BOWL), true)).advancementDessert().finish();

	public static final DeferredItem<Item> CRISP_RICE = EDItemGenerator.register("crisp_rice",
			() -> new Item(foodItem(FoodValues.COOKED_RICE))).advancementIngredients().finish();
	public static final DeferredItem<Item> CRISP_RICE_CEREAL = EDItemGenerator.register("crisp_rice_cereal",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.CEREAL).craftRemainder(Items.BOWL), true)).advancementMeal().finish();

	public static final DeferredItem<Item> CRISP_RICE_TREATS_BLOCK = EDItemGenerator.register("crisp_rice_treats_block",
			() -> new BlockItem(ExtraDelightBlocks.CRISP_RICE_TREATS.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> CRISP_RICE_TREAT = EDItemGenerator.register("crisp_rice_treat",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.PUFFED_RICE_TREAT), true)).advancementDessert().finish();

	public static final DeferredItem<Item> SCOTCHAROO_BLOCK = EDItemGenerator.register("scotcharoo_block",
			() -> new BlockItem(ExtraDelightBlocks.SCOTCHAROOS.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> SCOTCHAROO = EDItemGenerator.register("scotcharoo",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.SCOTCHAROO), true)).advancementDessert().finish();

	public static final DeferredItem<Item> BLACK_FOREST_TRIFLE_BLOCK = EDItemGenerator.register("black_forest_trifle_block",
			() -> new BlockItem(ExtraDelightBlocks.BLACK_FOREST_TRIFLE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> BLACK_FOREST_TRIFLE = EDItemGenerator.register("black_forest_trifle",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.BLACK_FOREST_TRIFLE), true)).advancementDessert().finish();
	...
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_FONDUE_BLOCK = EDItemGenerator.register("blood_chocolate_fondue_block",
			() -> new BlockItem(ExtraDelightBlocks.BLOOD_CHOCOLATE_FONDUE.get(), new Item.Properties())).advancementButchercraft().finish();
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_DIPPED_SWEET_BERRY = EDItemGenerator.register(
			"blood_chocolate_dipped_sweet_berry",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_SWEET_BERRY), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_DIPPED_GLOW_BERRY = EDItemGenerator.register(
			"blood_chocolate_dipped_glow_berry",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_GLOW_BERRY), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_DIPPED_APPLE_SLICE = EDItemGenerator.register(
			"blood_chocolate_dipped_apple_slice",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_APPLE), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_DIPPED_MARSHMALLOW = EDItemGenerator.register(
			"blood_chocolate_dipped_marshmallow",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_MARSHMALLOW), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_DIPPED_GRAHAM_CRACKER = EDItemGenerator.register(
			"blood_chocolate_dipped_graham_cracker",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_GRAHAM_CRACKER), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_DIPPED_BACON = EDItemGenerator.register("blood_chocolate_dipped_bacon",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_BACON), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_DIPPED_COFFEE_BEAN = EDItemGenerator.register(
			"blood_chocolate_dipped_coffee_bean",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_COFFEE_BEAN), true)).advancementButchercraft().finish();

	public static final DeferredItem<Item> DARK_CHOCOLATE_FONDUE_BLOCK = EDItemGenerator.register("dark_chocolate_fondue_block",
			() -> new BlockItem(ExtraDelightBlocks.DARK_CHOCOLATE_FONDUE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> DARK_CHOCOLATE_DIPPED_SWEET_BERRY = EDItemGenerator.register(
			"dark_chocolate_dipped_sweet_berry",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_SWEET_BERRY), true)).advancementCandy().finish();
	public static final DeferredItem<Item> DARK_CHOCOLATE_DIPPED_GLOW_BERRY = EDItemGenerator.register(
			"dark_chocolate_dipped_glow_berry",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_GLOW_BERRY), true)).advancementCandy().finish();
	public static final DeferredItem<Item> DARK_CHOCOLATE_DIPPED_APPLE_SLICE = EDItemGenerator.register(
			"dark_chocolate_dipped_apple_slice",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_APPLE), true)).advancementCandy().finish();
	public static final DeferredItem<Item> DARK_CHOCOLATE_DIPPED_MARSHMALLOW = EDItemGenerator.register(
			"dark_chocolate_dipped_marshmallow",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_MARSHMALLOW), true)).advancementCandy().finish();
	public static final DeferredItem<Item> DARK_CHOCOLATE_DIPPED_GRAHAM_CRACKER = EDItemGenerator.register(
			"dark_chocolate_dipped_graham_cracker",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_GRAHAM_CRACKER), true)).advancementCandy().finish();
	public static final DeferredItem<Item> DARK_CHOCOLATE_DIPPED_BACON = EDItemGenerator.register("dark_chocolate_dipped_bacon",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_BACON), true)).advancementCandy().finish();
	public static final DeferredItem<Item> DARK_CHOCOLATE_DIPPED_COFFEE_BEAN = EDItemGenerator.register(
			"dark_chocolate_dipped_coffee_bean",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_COFFEE_BEAN), true)).advancementCandy().finish();

	public static final DeferredItem<Item> MILK_CHOCOLATE_FONDUE_BLOCK = EDItemGenerator.register("milk_chocolate_fondue_block",
			() -> new BlockItem(ExtraDelightBlocks.MILK_CHOCOLATE_FONDUE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> MILK_CHOCOLATE_DIPPED_SWEET_BERRY = EDItemGenerator.register(
			"milk_chocolate_dipped_sweet_berry",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_SWEET_BERRY), true)).advancementCandy().finish();
	public static final DeferredItem<Item> MILK_CHOCOLATE_DIPPED_GLOW_BERRY = EDItemGenerator.register(
			"milk_chocolate_dipped_glow_berry",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_GLOW_BERRY), true)).advancementCandy().finish();
	public static final DeferredItem<Item> MILK_CHOCOLATE_DIPPED_APPLE_SLICE = EDItemGenerator.register(
			"milk_chocolate_dipped_apple_slice",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_APPLE), true)).advancementCandy().finish();
	public static final DeferredItem<Item> MILK_CHOCOLATE_DIPPED_MARSHMALLOW = EDItemGenerator.register(
			"milk_chocolate_dipped_marshmallow",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_MARSHMALLOW), true)).advancementCandy().finish();
	public static final DeferredItem<Item> MILK_CHOCOLATE_DIPPED_GRAHAM_CRACKER = EDItemGenerator.register(
	...
	public static final DeferredItem<Item> MILK_CHOCOLATE_DIPPED_BACON = EDItemGenerator.register("milk_chocolate_dipped_bacon",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_BACON), true)).advancementCandy().finish();
	public static final DeferredItem<Item> MILK_CHOCOLATE_DIPPED_COFFEE_BEAN = EDItemGenerator.register(
	...
	public static final DeferredItem<Item> WHITE_CHOCOLATE_FONDUE_BLOCK = EDItemGenerator.register("white_chocolate_fondue_block",
			() -> new BlockItem(ExtraDelightBlocks.WHITE_CHOCOLATE_FONDUE.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> WHITE_CHOCOLATE_DIPPED_SWEET_BERRY = EDItemGenerator.register(
			"white_chocolate_dipped_sweet_berry",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_SWEET_BERRY), true)).advancementCandy().finish();
	public static final DeferredItem<Item> WHITE_CHOCOLATE_DIPPED_GLOW_BERRY = EDItemGenerator.register(
			"white_chocolate_dipped_glow_berry",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_GLOW_BERRY), true)).advancementCandy().finish();
	public static final DeferredItem<Item> WHITE_CHOCOLATE_DIPPED_APPLE_SLICE = EDItemGenerator.register(
			"white_chocolate_dipped_apple_slice",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_APPLE), true)).advancementCandy().finish();
	public static final DeferredItem<Item> WHITE_CHOCOLATE_DIPPED_MARSHMALLOW = EDItemGenerator.register(
			"white_chocolate_dipped_marshmallow",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_MARSHMALLOW), true)).advancementCandy().finish();
	public static final DeferredItem<Item> WHITE_CHOCOLATE_DIPPED_GRAHAM_CRACKER = EDItemGenerator.register(
	...
	public static final DeferredItem<Item> WHITE_CHOCOLATE_DIPPED_BACON = EDItemGenerator.register("white_chocolate_dipped_bacon",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.DIPPED_BACON), true)).advancementCandy().finish();
	public static final DeferredItem<Item> WHITE_CHOCOLATE_DIPPED_COFFEE_BEAN = EDItemGenerator.register(
	...
	public static final DeferredItem<Item> ROASTED_PEANUTS = EDItemGenerator.register("roasted_peanuts",
			() -> new Item(foodItem(EDFoods.ROASTED_NUTS))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> PEANUT_BUTTER_JELLY = EDItemGenerator.register("peanut_butter_jelly",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.PBJ), true)).advancementMeal().finish();
	...
	public static final DeferredItem<Item> ICE_CREAM_SUNDAE = EDItemGenerator.register("ice_cream_sundae",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.ICE_CREAM_SUNDAE).craftRemainder(Items.GLASS_BOTTLE),
					true)).advancementDessert().finish();
	...
	public static final DeferredItem<Item> WHITE_CHOCOLATE_SYRUP_BOTTLE = EDItemGenerator.register("white_chocolate_syrup_bottle",
			() -> new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).food(EDFoods.CHOCOLATE_BAR))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> BLOOD_CHOCOLATE_SYRUP_BOTTLE = EDItemGenerator.register("blood_chocolate_syrup_bottle",
			() -> new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).food(EDFoods.CHOCOLATE_BAR))).advancementButchercraft().finish();

	public static final DeferredItem<Item> PEANUT_BUTTER_BOTTLE = EDItemGenerator.register("peanut_butter_bottle",
			() -> new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).food(EDFoods.NUT_BUTTER))).advancementIngredients().finish();

	public static final DeferredItem<Item> MARSHMALLOW_FLUFF_BOTTLE = EDItemGenerator.register("marshmallow_fluff_bottle",
			() -> new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).food(EDFoods.MARSHMALLOW_FLUFF))).advancementIngredients().finish();

	public static final DeferredItem<Item> HAZELNUT_SPREAD_BOTTLE = EDItemGenerator.register("hazelnut_spread_bottle",
			() -> new Item(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).food(EDFoods.HAZELNUT_SPREAD))).advancementIngredients().finish();
	...
	public static final DeferredItem<Item> ROMBOSSE = EDItemGenerator.register("rombosse",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.ROMBOSSE), true)).advancementDessert().finish();
	public static final DeferredItem<Item> APPLE_SLAW = EDItemGenerator.register("apple_slaw",
			() -> new Item(stack16FoodItem(EDFoods.APPLE_SLAW))).advancementMeal().finish();
	public static final DeferredItem<Item> PORK_AND_APPLES_FEAST = EDItemGenerator.register("pork_and_apples_feast",
			() -> new BlockItem(ExtraDelightBlocks.PORK_AND_APPLES_FEAST.get(), new Item.Properties())).advancementButchercraft().finish();
	public static final DeferredItem<Item> PORK_AND_APPLES = EDItemGenerator.register("pork_and_apples",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.PORK_AND_APPLES), true)).advancementButchercraft().finish();
	public static final DeferredItem<Item> APPLE_CHIPS = EDItemGenerator.register("apple_chips",
			() -> new Item(foodItem(EDFoods.APPLE_CHIPS))).advancementSnack().finish();
	public static final DeferredItem<Item> STUFFED_APPLES_FEAST = EDItemGenerator.register("stuffed_apples_feast",
			() -> new BlockItem(ExtraDelightBlocks.STUFFED_APPLES_FEAST.get(), new Item.Properties())).advancementFeast().finish();
	public static final DeferredItem<Item> STUFFED_APPLE = EDItemGenerator.register("stuffed_apple",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.STUFFED_APPLE), true)).advancementDessert().finish();
	public static final DeferredItem<Item> STUFFED_APPLE_ICE_CREAM = EDItemGenerator.register("stuffed_apple_ice_cream",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.STUFFED_APPLE_ICE_CREAM), true)).advancementDessert().finish();
	public static final DeferredItem<Item> MULLIGATAWNY_SOUP = EDItemGenerator.register("mulligatawny_soup",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.MULLIGATAWNY_SOUP), true)).advancementMeal().finish();
	...
	public static final DeferredItem<Item> TARTE_TATIN_SLICE = EDItemGenerator.register("tarte_tatin_slice",
			() -> new ToolTipConsumableItem(foodItem(EDFoods.TARTE_TATIN_SLICE), true)).advancementDessert().finish();
	...
	public static final DeferredItem<Item> CANDY_BAR_SALAD = EDItemGenerator.register("candy_bar_salad",
			() -> new ToolTipConsumableItem(stack16FoodItem(EDFoods.CANDY_BAR_SALAD), true)).advancementDessert().finish();
