...
public class ExtraDelightItems {
	...
	public static final DeferredItem<Item> CHEESECAKE_SLICE = EDItemGenerator
			.register("cheesecake_slice", () -> new Item(foodItem(FoodValues.PIE_SLICE))).advancementDessert().finish();
	...
	public static final DeferredItem<Item> QUICHE_SLICE = EDItemGenerator
			.register("quiche_slice", () -> new Item(foodItem(EDFoods.QUICHE))).advancementMeal().finish();
	...
	public static final DeferredItem<Item> PUMPKIN_ROLL = EDItemGenerator
			.register("pumpkin_roll", () -> new Item(foodItem(FoodValues.PIE_SLICE))).advancementDessert().finish();
	...
	public static final DeferredItem<Item> PUNCH = EDItemGenerator
			.register("punch", () -> new MelonJuiceItem(new Item.Properties())).advancementDrink().finish();
	...
	public static final DeferredItem<Item> CHOCOLATE_CAKE = EDItemGenerator
			.register("chocolate_cake", () -> new Item(foodItem(FoodValues.CAKE_SLICE))).advancementDessert().finish();
	...
	public static final DeferredItem<Item> CHILI_CHEESE_CORNBREAD_MUFFIN = EDItemGenerator
			...
			.advancementMeal().finish();
	public static final DeferredItem<Item> CHILI_CON_CARNE_FEAST = ITEMS.register("chili_con_carne_feast",
	...
	public static final DeferredItem<Item> CHILI_CON_CARNE = EDItemGenerator
			...
			.advancementMeal().finish();
	public static final DeferredItem<Item> WHITE_CHILI_FEAST = ITEMS.register("white_chili_feast",
			() -> new BlockItem(ExtraDelightBlocks.CHILI_CON_CARNE_FEAST.get(), new Item.Properties()));
	...
	public static final DeferredItem<Item> MISSISSIPPI_MUD_PIE = ITEMS.register("mississippi_mud_pie",
	...
	public static final DeferredItem<Item> MARSHMALLOW_ROOT_CRATE = ITEMS.register("marshmallow_root_crate",
			() -> new BlockItem(ExtraDelightBlocks.MARSHMALLOW_ROOT_CRATE.get(), new Item.Properties()));
	public static final DeferredItem<Item> MARSHMALLOW_POWDER_SACK = ITEMS.register("marshmallow_powder_sack",
			() -> new BlockItem(ExtraDelightBlocks.MARSHMALLOW_POWDER_SACK.get(), new Item.Properties()));
	public static final DeferredItem<Item> GRASSHOPPER_PIE = ITEMS.register("grasshopper_pie",
			() -> new BlockItem(ExtraDelightBlocks.GRASSHOPPER_PIE.get(), new Item.Properties()));
	public static final DeferredItem<Item> MARSHMALLOW_SLICE_FEAST = ITEMS.register("marshmallow_slice_feast",
	...
	public static final DeferredItem<Item> GREEN_COFFEE_BEAN_CRATE = ITEMS.register("green_coffee_bean_sack",
			() -> new BlockItem(ExtraDelightBlocks.GREEN_COFFEE_BEAN_SACK.get(), new Item.Properties()));
	public static final DeferredItem<Item> COFFEE_BEAN_CRATE = ITEMS.register("coffee_bean_sack",
			() -> new BlockItem(ExtraDelightBlocks.COFFEE_BEAN_CRATE.get(), new Item.Properties()));
	public static final DeferredItem<Item> ROASTED_COFFEE_BEAN_CRATE = ITEMS.register("roasted_coffee_bean_sack",
			() -> new BlockItem(ExtraDelightBlocks.ROASTED_COFFEE_BEAN_CRATE.get(), new Item.Properties()));
	...
	public static final DeferredItem<Item> CINNAMON_TOAST = EDItemGenerator
			...
			.advancementSnack().finish();
	public static final DeferredItem<Item> PANFORTE = ITEMS.register("panforte",
			() -> new BlockItem(ExtraDelightBlocks.PANFORTE.get(), new Item.Properties()));
