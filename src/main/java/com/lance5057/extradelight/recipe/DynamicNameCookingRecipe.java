...
public class DynamicNameCookingRecipe extends SmokingRecipe {
    ...
    public DynamicNameCookingRecipe(ResourceLocation id, String p_250200_, CookingBookCategory p_251114_,
    ...
    public static class Serializer implements RecipeSerializer<DynamicNameCookingRecipe> {
        @Override
        public DynamicNameCookingRecipe fromJson(ResourceLocation id, JsonObject pJson) {
            ...
            return new DynamicNameCookingRecipe(id, s, CookingBookCategory.MISC, ingredient, itemstack, f, i);
        }

        public DynamicNameCookingRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf pBuffer) {
