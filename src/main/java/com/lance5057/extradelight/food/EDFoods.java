...
public class EDFoods {
	...
	public static final FoodProperties APPLE_SLAW = new FoodProperties.Builder().nutrition(7).saturationModifier(0.19f).build();
	...
	public static final FoodProperties STUFFED_APPLE = new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).effect(COMFORT_MEDIUM, 1F).build();
	public static final FoodProperties STUFFED_APPLE_ICE_CREAM = new FoodProperties.Builder().nutrition(12).saturationModifier(0.23f).effect(COMFORT_LONG, 1F).build();
	public static final FoodProperties MULLIGATAWNY_SOUP = new FoodProperties.Builder().nutrition(11).saturationModifier(0.21f).effect(COMFORT_MEDIUM, 1F).build();
	...
	public static final FoodProperties CANDY_BAR_SALAD = new FoodProperties.Builder().nutrition(8).saturationModifier(0.31f).effect(COMFORT_MEDIUM, 1F).build();
}